...
const projects: Project[] = [
  ...
  },
  {
    ...
    slug: 'jobs_platform',
    description:
      'The job openings platform is a full-stack SPA built with Node.js and SQLite for multi-language support.',
    thumbnail: '/images/projects/jobs_platform/cover.jpg'
  }
];
